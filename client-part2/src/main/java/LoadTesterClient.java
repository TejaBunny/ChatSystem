...
// This version -- without Performance Report
...
//    private static final int WARMUP_MESSAGES = 32000;
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        long warmupDuration = warmupEndTime - warmupStartTime;
        // We'll just print a basic report for the warmup
...
//            Thread sender = new Thread(new MessageSender(url, roomId, queue, latch, messagesPerThread));
//            senderThreads.add(sender);
//            sender.start();
//        }
//
